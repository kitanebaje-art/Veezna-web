...
export default function AdminDashboardPage() {
  ...
  // Real-time Firestore Dashboard Aggregation
  useEffect(() => {
      ...
      try {
        ...
        try {
          ...
          studentSnap.forEach((d) => {
            ...
            if (status === "active" || status === "enrolled") activeCount++;
          });
        } catch {
        ...
        try {
          ...
          paymentsSnap.forEach((d) => {
            ...
            if (["paid", "success", "successful", "captured"].includes(status)) {
        ...
        console.error("Error aggregating admin metrics:", err);
      } finally {
  ...
  return (
    <div className="min-h-screen w-full bg-[#02142d] text-slate-100 flex flex-col font-sans antialiased relative overflow-x-hidden selection:bg-[#0057B8] selection:text-white">
      ...
      <div className="flex-1 flex flex-col min-w-0 z-10">
        ...
        {/* TOP HEADER CONTROL BAR WITH OFFICIAL LOGO SECTION */}
        <header className="sticky top-0 z-30 h-20 bg-[#042d5a]/80 backdrop-blur-xl border-b border-white/10 px-4 sm:px-8 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            {!logoError ? (
              ...
              /* Fallback Icon Badge if Logo Path Changes */
        ...
        <main className="flex-1 p-4 sm:p-8 space-y-8 max-w-7xl mx-auto w-full">
          ...
          {/* GLOBAL ECOSYSTEM BRAND PILLARS */}
          <section className="bg-[#042d5a]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-4 sm:p-5 shadow-lg">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-xs font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">
                ...
                <span>Veezna Platform Divisions</span>
              </div>

              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full md:w-auto">
                {[
                  { title: "VLS Engine", label: "Learning System", color: "text-blue-400", bg: "bg-blue-500/10" },
                  { title: "V-CPM Test", label: "Cognitive Mapping", color: "text-orange-400", bg: "bg-orange-500/10" },
                  { title: "Academic Hub", label: "Excellence Division", color: "text-purple-400", bg: "bg-purple-500/10" },
                  { title: "Wellness Framework", label: "Mind & Growth", color: "text-emerald-400", bg: "bg-emerald-500/10" },
                ].map((brand, idx) => (
                  <div
                    key={idx}
                  ...
                  >
                    ...
                    <div>
                      <div className="text-xs font-extrabold text-white leading-tight">{brand.title}</div>
          ...
          <Card3D className="bg-gradient-to-r from-[#003B7E] via-[#0057B8] to-[#042d5a] border border-blue-400/30 p-6 sm:p-10 text-white shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl space-y-3">
              ...
              <p className="text-xs sm:text-sm text-blue-100/90 font-medium leading-relaxed">
                Welcome to your Veezna Executive Command Center. Real-time metrics are synced across admissions, student performance, fee collections, and VLS curriculum operations.
              </p>
            </div>
          </Card3D>

          {/* DYNAMIC REAL-TIME 3D STATISTICS CARDS */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <Card3D className="bg-[#042d5a]/70 backdrop-blur-xl border border-white/15 p-6 shadow-xl">
              ...
              <div className="mt-4 flex items-baseline justify-between">
                <span className="text-3xl font-black text-white tracking-tight">
                  {metricsLoading ? "..." : metrics.totalStudents}
                </span>
                <span className="text-[11px] font-medium text-slate-400">Synced to Firestore</span>
              </div>
            </Card3D>
            ...
            <Card3D className="bg-[#042d5a]/70 backdrop-blur-xl border border-white/15 p-6 shadow-xl">
              ...
              <div className="mt-4 flex items-baseline justify-between">
                <span className="text-3xl font-black text-white tracking-tight">
                  {metricsLoading ? "..." : metrics.activeStudents}
                </span>
                <span className="text-[11px] font-semibold text-emerald-400">Verified Active</span>
              </div>
            </Card3D>
            ...
            <Card3D className="bg-[#042d5a]/70 backdrop-blur-xl border border-white/15 p-6 shadow-xl">
              ...
              <div className="mt-4 flex items-baseline justify-between">
                <span className="text-3xl font-black text-white tracking-tight">
                  {metricsLoading ? "..." : metrics.pendingAdmissions}
                </span>
                <span className="text-[11px] font-semibold text-amber-400">Action Required</span>
              </div>
            </Card3D>

            {/* Card 4: Total Fees Revenue */}
            <Card3D className="bg-[#042d5a]/70 backdrop-blur-xl border border-white/15 p-6 shadow-xl">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-400">
                  Fees Revenue
              ...
              <div className="mt-4 flex items-baseline justify-between">
                <span className="text-2xl sm:text-3xl font-black text-white tracking-tight">
                  {metricsLoading ? "..." : formatINR(metrics.feesCollected)}
                </span>
                <span className="text-[11px] font-medium text-slate-400">Verified Paid</span>
              </div>
            </Card3D>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-[#042d5a]/60 backdrop-blur-xl border border-white/15 rounded-3xl p-8 sm:p-12 text-center shadow-lg flex flex-col items-center justify-center">
              ...
              <p className="text-xs text-slate-400 mt-1 max-w-sm font-medium leading-relaxed">
                Real-time activity logs for new student enrollments, VLS progress updates, fee transactions, and attendance records will appear here as transactions occur.
              </p>
            </div>
          </section>
