...
export default function CampusExperienceGallery() {
  ...
  const [isFeaturedHovered, setIsFeaturedHovered] =
    useState(false);
  ...
  const galleryItems: GalleryItem[] = [
    {
      ...
      caption:
        'Interactive, small-batch learning environments focused on analytical clarity and board prep.',
      badgeBg:
        'bg-blue-50 text-[#0057B8] border-blue-200/60',
      badgeText: 'Academic',
      gradientOverlay:
        'from-[#0057B8]/80 via-[#0057B8]/40 to-transparent',
...

    {
      ...
      caption:
        'Dynamic public speaking, debates, accent refinement, and real-time interview simulations.',
      badgeBg:
        'bg-amber-50 text-[#F7931E] border-amber-200/60',
      badgeText: 'Vox English',
      gradientOverlay:
        'from-[#F7931E]/80 via-[#F7931E]/40 to-transparent',
...

    {
      ...
      title: 'Tech & Code Lab',
      caption:
        'Hands-on full-stack development studio featuring modern frameworks, Next.js, and live projects.',
      badgeBg:
        'bg-cyan-50 text-[#0284C7] border-cyan-200/60',
      badgeText: 'Technology',
      gradientOverlay:
        'from-[#00BFFF]/80 via-[#0284C7]/40 to-transparent',
      spanCol: 'lg:col-span-1',
      spanRow: 'lg:row-span-1',
      svgVisual: (
        <svg
...

    {
      ...
      caption:
        'Group brainstorming hubs engineered to foster peer mentorship and creative problem solving.',
      badgeBg:
        'bg-indigo-50 text-[#6366F1] border-indigo-200/60',
      badgeText: 'Community',
      gradientOverlay:
        'from-[#6366F1]/80 via-[#6366F1]/40 to-transparent',
      spanCol: 'lg:col-span-2',
      spanRow: 'lg:row-span-1',
      svgVisual: (
        <svg
...

    {
      ...
      caption:
        'Masterclasses delivered by industry veterans, career mentors, and education specialists.',
      badgeBg:
        'bg-purple-50 text-[#8B5CF6] border-purple-200/60',
      badgeText: 'Seminars',
      gradientOverlay:
        'from-[#8B5CF6]/80 via-[#8B5CF6]/40 to-transparent',
      spanCol: 'lg:col-span-1',
      spanRow: 'lg:row-span-1',
      svgVisual: (
        <svg
...

    {
      ...
      caption:
        'Peaceful, confidential spaces dedicated to personal guidance, stress management, and wellbeing.',
      badgeBg:
        'bg-emerald-50 text-[#059669] border-emerald-200/60',
      badgeText: 'Wellness',
      gradientOverlay:
        'from-[#10B981]/80 via-[#10B981]/40 to-transparent',
      spanCol: 'lg:col-span-1',
      spanRow: 'lg:row-span-1',
      svgVisual: (
        <svg
...

    {
      ...
      caption:
        'Celebrating academic milestones, student transformations, and excellence awards.',
      badgeBg:
        'bg-rose-50 text-[#E11D48] border-rose-200/60',
      badgeText: 'Events',
      gradientOverlay:
        'from-[#E11D48]/80 via-[#E11D48]/40 to-transparent',
      spanCol: 'lg:col-span-1',
      spanRow: 'lg:row-span-1',
      svgVisual: (
        <svg
    ...
    selectedCategory === 'All'
      ...
      : galleryItems.filter(
          (item) =>
            ...
            item.badgeText.includes(selectedCategory)
        );
  ...
  const handleFeaturedMouseMove = (
    ...
    const rect =
      featuredCardRef.current.getBoundingClientRect();
  ...
  const campusHighlights = [
    {
      ...
      desc:
        'Ergonomic, high-tech environments designed for immersive, concept-driven focus.',
      icon: (
        <svg
...

    {
      ...
      desc:
        'Accomplished educators and certified specialists guiding every step of growth.',
      icon: (
        <svg
          className="w-6 h-6 text-[#F7931E]"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
...

    {
      ...
      desc:
        'Hands-on practical projects, group communication drills, and live application labs.',
      icon: (
        <svg
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M9.663 17h4.673M12 3v1m6.364 1.636l-0.707 0.707M21 12h-1M4 12H3m3.343-5.657l-0.707-0.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 01-2 2h-2a2 2 0 01-2-2v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"
          />
        </svg>
      ),
    },

    {
      ...
      desc:
        'Tailored roadmaps, interview prep, public speaking mastery, and future planning.',
      icon: (
        <svg
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16 sm:mb-20">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-600 font-normal leading-relaxed">
            Every classroom, every activity and every achievement reflects
            our commitment to transforming lives through education.
          </p>
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl space-y-6">
              ...
              <p className="text-slate-200 text-base sm:text-lg lg:text-xl font-normal leading-relaxed">
                "Practical experiences, engaging classrooms and a supportive
                environment designed for every learner."
              </p>
        ...
        <div
          id="full-gallery"
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-24"
        >
          {filteredItems.map((item) => (
            <div
              key={item.id}
              className={`relative group rounded-[32px] bg-white/80 border border-slate-200/80 backdrop-blur-xl p-6 sm:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_50px_rgba(0,87,184,0.12)] hover:border-slate-300 transition-all duration-500 flex flex-col justify-between overflow-hidden cursor-pointer ${
                item.spanCol || ''
              } ${item.spanRow || ''}`}
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-t ${item.gradientOverlay} opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10`}
              />

              <div className="relative z-20 flex items-center justify-between mb-8">
                <span
                  className={`px-3 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider border ${item.badgeBg}`}
                >
                  {item.badgeText}
                </span>
        ...
        <div className="my-20 p-8 sm:p-12 rounded-[32px] bg-white/80 border border-slate-200/80 backdrop-blur-xl shadow-xl shadow-slate-200/50">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
            {[
              ...
              <div
                key={i}
                className={i !== 0 ? 'pt-6 lg:pt-0' : ''}
              >
                <div
                  className={`text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight ${stat.color}`}
                >
                  <AnimatedCounter
                    end={stat.val}
                    suffix={stat.suffix}
        ...
        <div className="relative rounded-[32px] bg-gradient-to-r from-[#0057B8] via-[#00418A] to-[#002855] text-white p-8 sm:p-12 lg:p-16 shadow-2xl overflow-hidden border border-white/10">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-slate-200 text-sm sm:text-base lg:text-lg font-normal leading-relaxed max-w-2xl mx-auto">
              Discover a place where learning, creativity and personal growth
              come together.
            </p>
